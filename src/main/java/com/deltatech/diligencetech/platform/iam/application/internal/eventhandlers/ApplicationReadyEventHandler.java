package com.deltatech.diligencetech.platform.iam.application.internal.eventhandlers;
...
public class ApplicationReadyEventHandler {
    ...
    public void on(ApplicationReadyEvent event) {
        ...
        LOGGER.info("Finished verifying if roles seeding is needed for {} at {}", applicationName, getCurrentTimestamp());
    }
